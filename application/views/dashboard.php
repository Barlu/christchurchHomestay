...
<section>
    ...
    <div role="tabpanel">
        ...
        <ul id="admin-nav" class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation"><a href="#calendar-wrap" aria-controls="calendar" role="tab" data-toggle="tab">Calendar<i class="fa fa-calendar middle"></i></a></li>
        ...
        <div class="admin tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade" id="calendar-wrap"></div>
