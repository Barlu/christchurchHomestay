...
class MY_Model extends CI_Model {
    ...
    /**
     * Controller for inserting/updating single records
     */
    public function save($data, $id = null) {
        ...
        if ($id === null) {
            ...
            $this->insert($data, $skip_validation);
        } else {
            $this->update($id, $data, $skip_validation);
        }
    }
    ...
    /**
     * Populates class specific attributes with data
     * 
     * @param array $row
     */
